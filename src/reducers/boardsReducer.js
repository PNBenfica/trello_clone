import { FETCH_BOARDS, FETCH_BOARD_DETAILS, SET_ACTIVE_BOARD } from '../actions/ActionTypes'
...
function getBoards(){
    ...
    let boards = [...Array(9).keys()].map(n => { return { id: n, name: "Project " + n, color: colors[n], lists:[n, n + 10, n + 20] }} )
